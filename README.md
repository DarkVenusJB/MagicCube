...
## Основные сложности
Для реализации DragAndDrop механики пришлось воспользоваться New Input System, с которой ранее не был знаком. Также возникли сложности с реализацией системы точек, в которые возвращаются кубы, когда пользователь отпускает ЛКМ. Текущая система точек мне не очень нравится, так как она требует ручной расстановки точек.
